<template v-slot:header>
  <header
    :style="{
      backgroundColor: currentRoute === '/' ? 'rgba(0, 0, 0, 0)' : '#6d49f6'
    }"
  >
    <div class="logo">
      <a href="/" target="_top">
        <img
          src="../../assets/photos/Logo_siden.png"
          alt="Logo"
          target="_top"
          href="/"
        />
      ...
      <nav>
        <ul class="nav-menu">
          <li v-for="item in menu" :key="item.name">
            <router-link
              v-if="!item.hasOwnProperty('userState')"
              class="menuItem"
              :to="item.url"
    ...
    <div v-else>
      <div id="menu-button">
        <img
          src="../../assets/photos/Hamburger_icon.png"
          alt="Hamburger Icon"
          @click="toggleMenu"
        />
