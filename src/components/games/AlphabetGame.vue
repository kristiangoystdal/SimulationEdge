<template>
  ...
  <div id="mobileBox">
    <input id="inputField" type="text" v-model="mobileInput" @input="handleMobileKey" @keydown="handleMobileKeyDown"
      ref="mobileInput">
  </div>
...
import helpText from '../../data/txtFiles/AlphabetGameHowTo.md?raw';
...
#chip {
  ...
  text-align: center;
  font-size: 20px;
  /* Replace 'auto' with a specific font size */
  border: solid;
}
